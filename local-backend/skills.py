...
SKILLS = dict([
    ...
    _skill(
        ...
        "effort|null, credId|null (CUÁL de las API keys del orquestador usa; null = la primera "
        "cargada de ese proveedor)}, "
        ...
        "secuencial:bool (default false; true = ese agente NUNCA delega en paralelo: "
        "va de a uno esperando cada respuesta) }. "
